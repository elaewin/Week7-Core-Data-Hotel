...
-(void)setupRootViewController {
    ...
    // assign root vc of window
    self.window.rootViewController = self.navigationController;
    
    // makes this the key window and shows it.
...
-(void)bootstrapApp {
    ...
    if (count == 0) {
        ...
        if (isSaved) {
            ...
            NSLog(@"Data not saved - SAVE ERROR: %@", saveError.localizedDescription);
        }
    } else {
        NSLog(@"Bootstrapping unnecessary; data already exists in Core Data.");
    }
}
